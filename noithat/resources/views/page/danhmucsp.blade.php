...
<div id="breadcrumb">
    <div class="container">
        <ul class="breadcrumb">
            ...
            <li class="active">Danh mục sản phẩm : {{$loai_sp->name}}</li>
        </ul>
    </div>
</div>
<!-- /BREADCRUMB -->
    ...
    <div class="container">
        ...
        <div class="row">
                    ...
                    <div class="product product-widget" style="border-bottom: 1px solid #ccc;">
                        ...
                        <div class="product-body">
                            <h2 class="product-name">
                                <a href="{{route('chitietsanpham',$spkhac->id)}}">{{$spkhac->name}}</a>
                            </h2>
            ...
            <div id="main" class="col-md-9">
                <h3 class="aside-title">{{$loai_sp->name}}</h3>
                <!-- STORE -->
                <div id="store">
                    <div class="row">
                            ...
                            <div class="product product-single">
                                <div class="product-thumb">
                                    ...
                                    <button class="main-btn quick-view">
                                        <a href="{{route('chitietsanpham',$sp->id)}}"><i class="fa fa-search-plus"></i> view detail</a>
                                    </button>
                                ...
                                <div class="product-body">
                                    <h3 class="product-price">
                                        ...
                                        <span class="product-old-price">{{number_format($sp->promotion_price)}} VND</span><br>
                                        <del class="product-price" style="font-size: 10px;">{{number_format($sp->unit_price)}} VND</del>
                                        @else
                                        <span class="product-old-price" style="font-size: 18px;">{{number_format($sp->unit_price)}} VND</span><br><br>
                                        @endif
                                    </h3>
                                    <div class="product-rating">
                                        <i class="fa fa-star"></i>
